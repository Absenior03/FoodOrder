...
import InteractiveItemCard from './InteractiveItemCard';

interface InteractiveItemGridProps {
  items: FoodItem[];
  isLoading?: boolean;
  showStockAnimation?: boolean;
}

const InteractiveItemGrid: React.FC<InteractiveItemGridProps> = ({ 
  items, 
  isLoading = false, 
...
export default InteractiveItemGrid;